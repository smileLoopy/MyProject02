...
<table border="1" width="90%">
    ...
    <tr>
        <td colspan="4" align="center">
            ...
            <button type="button" onclick="location.href='../mynotice/pass_notice.do?mode=edit&idx=${param.idx}';">
                수정하기
            </button>
            <button type="button" onclick="location.href='../mynotice/pass_notice.do?mode=delete&idx=${param.idx}';">
                삭제하기
            </button>
            <button type="button" onclick="location.href='../mynotice/list_notice.do';">
                목록 바로가기
            </button>
        </td>
    </tr>
