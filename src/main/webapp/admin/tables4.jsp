...
<html lang="en">
    <head>
        ...
        <script src="https://use.fontawesome.com/releases/v6.1.0/js/all.js" crossorigin="anonymous"></script>
		    ...
		    <!-- 절대경로 -->
		    <link href="http://localhost:8082/MariaMVCBoard/admin/css2/bootstrap.min.css" rel="stylesheet" type="text/css">
				
				<!-- Custom CSS -->
			 <link href="css2/style.css" rel="stylesheet">
			 <!-- 절대경로 -->
			 <link href="http://localhost:8082/MariaMVCBoard/admin/css2/style.css" rel="stylesheet">
				<link rel="stylesheet" href="fonts/stylesheet.css">
				<link href="css2/mb-comingsoon-iceberg.css" rel="stylesheet" />
				<!-- 절대경로 -->
				<link href="css2/mb-comingsoon-iceberg.css" rel="stylesheet" />
...
<%-- 		          	<header class="sub-header" style="border: 1px solid red; display: inline-block">
	...
	<c:otherwise>
		<c:forEach items="${boardLists }" var="row" varStatus="loop">
			<tr>
				<td>${row.idx }</td>
				<td>
					<a href="http://localhost:8082/MariaMVCBoard/mynotice/view_notice2.do?idx=${row.idx }">${row.title }</a>
				</td>
				<td>${row.title }</td>
				<td>${row.name }</td>
				<td>${row.viewcount }</td>
